...
$qtd = $res->num_rows;
        ...
        if($qtd > 0){
            print "<div class='alert alert-success col-8 mx-auto' role='alert'> Estão registradas <b>$qtd</b> Resposta(s)<br/> Que se encontram listadas abaixo em ordem Recente!</div>";
            ...
            print "<div class='alert alert-danger col-6 mx-auto' role='alert'> Não existem questões registrados!</div>";
        }
?>
        </div>
    </div>
