...
include("../prof/verifica.php");
    ...
    $edit = "SELECT * FROM professor WHERE email_professor = '{$_SESSION['usuarioprof']}'";
...
<div class="col-sm-9 col-md-7 col-lg-10 mx-auto">
        <div class="card card-signin my-5">
            <div class="card-body col-10 mx-auto">
                <h5 class="card-title text-center">Editar Cadastro de <?php print $ecu["nome_professor"]; ?></h5>
                <form action="?page=edit-perfil&acao=salvar" method="POST">
                    <div class="form-row">
                        
                        <div class="col-md" style="margin-top:3%">
                            <h5>Nome Completo</h5>
                            <input id="entrace" type="text" class="form-control" name="nome_professor" value="<?php print $ecu["nome_professor"]; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md" style="margin-top:3%">
                            <h5>Email</h5>
                            <input id="entrace" type="email" id="inputEmail" class="form-control" name="email_professor" value="<?php print $ecu["email_professor"];?>" required autofocus>
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="?page=delete-prof" id="btn" class="btn btn-danger text-uppercase">Deletar</a>
                </div>
                </form>
            </div>
        </div>
