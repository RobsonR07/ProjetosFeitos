            ...
            print "<table class='table table-striped table-dark col-12 mx-auto' style='border-style: solid; border-width: 2px; border-color:#e8b200;'>";
                ...
                print "</tr>";
                    while($row = $res->fetch_assoc()){
                        print "<tr>";
                        print "<td>".$row["id_curriculo"]."</td>";
                        print "<td>".$row["nome_funcionario"]."</td>";
                        print "<td>".$row["cargo_funcionario"]."</td>";
                        print "<td><a class='btn btn-outline-warning' href='?pageadm=analise-curriculo&id_curriculo=".$row["id_curriculo"]."'><i class='fas fa-search'></i></a></td>";
                        print "</tr>";
                    }
            print "</table>";
           
            }else{
                print "<div class='alert alert-danger col-6 mx-auto' role='alert'> Não existem candidatos registrados!</div>";
            }
?>
        </div>
    </section>
